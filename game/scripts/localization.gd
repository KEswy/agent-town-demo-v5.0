...
const ENGLISH := {
	...
	"选择要观看的进行中对局": "Pick a live game to watch",
	"等待对局": "Waiting for a game",
	...
	"完成 ": "Hands: ",
	" 手 | 净输赢 ": " | Net ",
	" | 单手最大赢 ": " | Best single win ",
	"最佳牌型 ": "Best hand: ",
	" | 顺子/同花/葫芦/四条/同花顺胜场 ": " | Straight/Flush/FullHouse/Quads/SF wins ",
	"横扫全场 ": "Sweeps: ",
	" 次 | 单手 500+ ": " | Big wins (500+): ",
	" 次": " times",
	"高牌": "High card",
	"一对": "Pair",
	"两对": "Two pair",
