...
V3.1-A 已建立可复现模拟，V3.1-B/M02-A 已建立第一版核心指标，V3.1-C/M03-A 锁住合法证据和变化链，V3.1-D/M03-B 补齐衰减与私聊边界，V3.1-E/M04-A 已完成 shadow 连续性对照，V3.1-F/M04-B 已让普通非警长白天发言受控读取统一 stance。下一步优先扩展 M06 隐藏信息不变性矩阵与 M09 LLM 可观测性，再用 M15 做多种子投票校准；警长票和放逐票暂不直接消费 stance。
