...
- **自由开局**：进游戏直接落在小镇，不再弹狼人杀窗口；每名 NPC 开局就待在自己的
  建筑旁走动（梅西/C罗在球场、奇异博士守至圣所、然然在邮局……），走近任意 NPC
  按 E 聊天；走近「德州扑克馆」按 E 进扑克牌桌，走近会议广场南边的「桌游馆」按 E
  开始/继续狼人杀——狼人杀开始时 NPC 才会走到专门的狼人杀场地围成一圈。
