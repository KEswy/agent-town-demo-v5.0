...
WOLF_SELF_KILL_POLICY_VERSION = "wolf_self_kill.v1"
WOLF_FAKE_GOD_CLAIM_POLICY_VERSION = "wolf_fake_god_claim.v1"
...
NPC_VOICE_OPENERS: dict[str, list[str]] = {
    "梅西": ["我稳着说，", "慢慢捋一捋，", "先看证据再下结论。"],
    "C罗": ["听我说，", "这话我说在前头，", "我直接讲——"],
    "周深": ["我小声说一句，", "我倒是觉得，", "那个……我说说看，"],
    "梅长苏": ["从逻辑上看，", "不妨理一理，", "按因果关系讲，"],
    "塞尔达": ["行动见真章，", "我信可验证的事，", "先做，再讲。"],
    "小骑士": ["嗯。", "直接说结论，", "不多解释，" ],
    "大黄蜂": ["先别急着过，", "我盯上了，", "这句话要打个问号，"],
    "喜羊羊": ["诶，我想到了，", "我有个主意——", "咱们拆开看，"],
    "懒羊羊": ["嘛，", "唉呀，", "随便说说，"],
    "洛洛": ["按顺序看，", "系统一点看，", "先列清楚再选，"],
    "奇异博士": ["可能性很多，", "先看最可能的，", "换条时间线看——"],
}
