...
跨日保持 `77.4%→87.5%`。扩展 30 局六项核心指标全部改善：胜场 `43.3%→50.0%`、
误投 `48.3%→42.7%`、投狼概率质量 `53.3%→59.0%`、放逐熵 `30.3%→28.0%`、跨日
保持 `66.2%→81.2%`；重放 `30/30`、零 fallback，金丝雀门槛
通过。人工标签清洗（tonystark 确认 99 条）与模型重训已于 2026-08-04 完成，
默认模式已切换为 `local`；同日平衡微调（6 名偏好人 NPC `decision_variance`
+0.20）后好人胜率约 50%（更接近五五开）；`rule` 仍可通过环境变量或开局选项
