...
10 局 seed `20260727–20260736` 为好人胜场 `2→3`、误投 `62.6%→58.3%`、放逐熵
`25.1%→26.4%`、跨日保持 `77.4%→87.5%`；扩展 30 局 seed
`20260601–20260630` 胜率持平、其余四项核心指标改善（胜场 `46.7%→46.7%`（持平）、误投
...
`rule` 仍可通过环境变量或开局选项显式选择。2026-08-04 平衡微调后好人胜率约
43%；规则发言模板变体上线后模板重复率 `25.2%→13.1%`。
